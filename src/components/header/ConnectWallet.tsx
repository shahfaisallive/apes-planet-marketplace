  ...
  return (
    <div className="sc-btn-top mg-r-12" id="site-header" >
        { walletAvail ?
                <>
                {!connected ? 
                <button disabled={connected} onClick={connectHandler} className="sc-button header-slider style style-1 wallet fl-button pri-1">
                <span>Connect Wallet</span>
                </button> : <button onClick={disconnectHandler} className="sc-button header-slider style style-1 wallet fl-button pri-1">
